export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", assign: "Select a Key model for {{capability}} first", noMatch: "No matching {{capability}} models", addFirst: "Synchronize or create an available Key in account settings first", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" } },
    },
    ...
    canvas: {
        ...
        projectPage: {
            localMediaRestoreFailed: "Some local media could not be read. The canvas was opened with its saved data.",
        ...
        plugins: { title: "Node plugins", installedPlugin: "Installed plugin {{name}}", installed: "Installed {{name}}", installFailed: "Installation failed: {{error}}", enabled: "Enabled", disabled: "Disabled", upgradeAvailable: "New version available — click to upgrade", updateFromSource: "Update from source", updated: "Updated", uninstallTitle: "Uninstall this plugin?", uninstall: "Uninstall", newVersion: "A new version is available", officialDescription: "Official plugins from this project's registry", refresh: "Refresh", loadFailed: "Failed to load: {{error}}", loadingOfficial: "Loading official plugins…", noOfficial: "No official plugins", install: "Install", urlPlaceholder: "Enter a plugin JavaScript URL, for example https://.../plugin.js", noThirdParty: "No third-party plugins installed", official: "Official", local: "Local", thirdParty: "Third-party", warning: "Plugin code runs directly on this page and may access local page data. Only install plugins from trusted sources. The plugin SDK does not expose complete official keys.", aiConfigRequired: "AI models are unavailable. Synchronize or create a website key in account settings first.", interactiveTitle: "Interaction mode is active. Click to switch to Move mode and drag the node.", movableTitle: "Move mode is active. Click to switch to Interaction mode and operate the node content.", move: "Move", interact: "Interact" },
    ...
    topNav: {
        ...
        qqGroup: "Copy QQ group: 1084450051",
        qqGroupCopied: "QQ group number copied",
    ...
    account: {
        title: "USA0 Account",
        subtitle: "Authentication and website key management",
        connectTitle: "Connect your website account",
        connectDescription: "Sign in through the USA0 authorization window. An existing website session continues directly; new users can register on the website.",
        login: "Sign in or register",
        openWebsite: "Open USA0 website",
        connected: "Connected",
        needsKey: "Key required",
        syncIssue: "Sync issue",
        keyTotal: "Website keys",
        modelTotal: "Synced models",
        keysTitle: "API keys",
        keysDescription: "All keys stay synchronized with the website, and each available key independently exposes models from its group.",
        syncKeys: "Sync keys",
        keysSynced: "Keys synchronized with the website",
        createKeyTitle: "Create a website key",
        createKeyDescription: "Select its website group. Confirming creates the key on the website as well.",
        createGroup: "Website group",
        selectGroup: "Select a group",
        createKey: "Create key",
        keyCreated: "Key created and synchronized",
        deleteKeyTitle: "Delete website key",
        deleteKeyConfirm: "Delete “{{name}}”? The same key will also be deleted from the website.",
        keyDeleted: "Key deleted from the website",
        noKeysCreate: "No keys yet. Select a group to create one.",
        noGroups: "No groups are available. Configure a group on the website first.",
        noGroup: "No group",
        modelCount: "{{count}} models",
        syncFailed: "Sync failed",
        viewUsage: "View usage",
        usageSummary: "Balance {{balance}} · Today {{today}} tokens · Total {{total}} tokens",
        keySourceUnavailable: "The website key for this model was deleted or is unavailable. Select another model.",
        modelCapabilities: { text: "Text", image: "Image", video: "Video", audio: "Audio" },
        logout: "Sign out",
        keyReasons: { disabled: "Disabled", ungrouped: "No group", expired: "Expired", quotaExhausted: "Quota exhausted" },
        progress: {
            restoring: "Restoring your account session...",
            authorizing: "Waiting for authorization on the USA0 website...",
            syncing: "Synchronizing your account, keys, and models...",
        },
        summary: {
            restoring: "Restoring account information...",
            notSignedIn: "Sign in to synchronize website keys, models, and usage.",
            userId: "User ID",
            apiKeyName: "Inspected key",
            noSelectedKey: "No available key",
            group: "Group",
            none: "None",
            ...
            currentKeyUsage: "Key usage",
            inspectedKeyUsage: "{{name}} usage",
            balance: "Available balance",
            todayTokens: "Tokens today",
            totalTokens: "Lifetime tokens",
            quotaUsage: "Quota usage",
            refreshUsage: "Refresh usage",
            usageUnavailable: "Usage for the inspected Key is currently unavailable.",
            usageStale: "Latest usage is unavailable. The last result is still shown.",
            logoutFailed: "Unable to sign out. Please try again.",
            updatedAt: "Updated at {{time}}",
            selectKeyHint: "Create or synchronize an available key in account settings.",
    ...
    config: {
        ...
        description: "Default models, generation preferences, sync, and local storage",
        modalDescription: "Preferences, prompt sources, sync, and local storage",
        tabs: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by USA零, grouped by object store.",
        ...
        fileSecurity: "Website Keys are excluded from settings files. The JSON may still contain WebDAV credentials, so keep it secure.",
    ...
    agent: {
        ...
        connect: { pluginTitle: "Option 1: Use the Codex plugin", pluginText: "Download the complete USA0 Codex plugin. Once installed, it starts the local Agent and supplies the connection details automatically.", pluginContents: "Complete plugin · 2 Skills + Canvas Agent MCP", downloadPlugin: "Download Codex plugin", pluginDownloadFailed: "The Codex plugin could not be downloaded. Confirm that this deployment includes the plugin package.", installStepDownload: "Download the ZIP and extract it to any temporary folder.", installStepRun: "Run the installation command for your system from the extracted folder.", installStepRestart: "Start a new Codex task and ask: Help me open and connect to USA0.", manualInstall: "View manual installation commands", installUpdateHint: "Run the installer again to update. Start a new Codex task after installation or update to load the new Skills and MCP.", directTitle: "Option 2: Run the Agent directly", directText: "To connect without installing Codex canvas tools, run the Agent in a terminal and return here. This does not add Skills or MCP to Codex.", commandCopied: "Command copied", pluginReminder: "Codex plugin note", pluginReminderText: "The tool list enters the Codex context and consumes additional tokens only after installing the Codex plugin or adding MCP manually. Running npx -y @basketikun/canvas-agent alone does not install MCP.", removePlugin: "Remove plugin", removeMcp: "Remove manual MCP", copyCommand: "Copy command", title: "Connect local Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
