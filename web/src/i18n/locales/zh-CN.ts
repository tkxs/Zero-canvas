export default {
    ...
    account: {
        ...
        summary: {
            ...
            unknown: "未知",
            syncedModels: "同步模型",
            currentKeyUsage: "当前 Key 用量",
            balance: "可用余额",
            todayTokens: "今日 Token",
            totalTokens: "累计 Token",
            quotaUsage: "额度使用",
            refreshUsage: "刷新用量",
            usageUnavailable: "暂时无法获取当前 Key 用量。",
            usageStale: "暂时无法获取最新用量，已保留上次数据。",
            logoutFailed: "退出登录失败，请重试。",
            updatedAt: "更新于 {{time}}",
            selectKeyHint: "请到账户管理中选择一个可用 Key。",
