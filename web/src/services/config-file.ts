...
export function exportAppConfig() {
    ...
    const data: AppConfigFile = { app: "infinite-canvas", version: 1, exportedAt: new Date().toISOString(), config: sanitizeConfigSecrets(config), webdav, promptSources: { sources, schedule } };
