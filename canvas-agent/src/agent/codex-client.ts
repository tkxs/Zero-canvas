...
export class CodexAppClient {
    ...
    static async start(emit: AgentEmit, onExit: () => void) {
        ...
        await client.request("initialize", { clientInfo: { name: "canvas-agent", title: "USA零 Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });
